...
class PDOWrapper
{
    ...
    private function connect()
    {
        ...
        try{
            //PDO中唯一自动走异常的
            self::$pdo = new PDO("{$this->type}:host={$this->host};port={$this->port};dbname={$this->dbname};charset={$this->charset}",$this->user,$this->pass);
    ...
    public function getOne($sql)
    {
        ...
        try{
           ...
           return  $stmt->fetchObject(get_called_class());
            ...
            //解析
            //return $stmt->fetch(PDO::FETCH_CLASS, get_called_class());
        }catch(PDOException $e){
            //调用错误信息处理方法
            $this->error($e);
        }
